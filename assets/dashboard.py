...
class DashboardWindow(QWidget):
    ...
    def init_sidebar(self):
        ...
        # Logo + Title
        logo_label = QLabel()
        logo_pixmap = QPixmap("assets/logo.png").scaled(120, 120, Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    def init_home(self):
        ...
        card_layout.addWidget(create_card("🕒", "Attendance Today", attendance_today, "#17a2b8"))
        card_layout.addWidget(create_card("✅", "Active Unit", active_unit, "#ffc107"))
